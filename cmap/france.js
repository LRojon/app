...
*/
		var mapfill = "#501e38";		// Couleur de remplissage des régions
		var maphover_fill = "#e95420";	// Couleur de survol au passage de la souris
		...
		var mapWidth=100;				// Largeur de la carte en pixels
		var mapHeight=100;				// Hauteur de la carte en pixels (facultatif)
